...
\033[1;94m ┈┈┈▕TAmim▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕TAmim▏▏┈┈┈
...
\033[1;91m☞ Auther     : Tamim Uddin 

\033[1;92m☞ WhatsApp   : No need
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num no need✓')

	    psb('WellCome To B4_TAMIM')

	    psb('Congratulations B4_TAMIM Tool Has Been Updated Successfully')

	    psb('🔓User Name☆ Tamim✓')

	    psb('🔓Password ☆ Uddin✓')

	    psb('Subscrib My Youtube Channel Black mafia team 619✓')
